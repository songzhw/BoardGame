            ...
            switch (player.wunature) {
              case "wood":
                if (player.num("he")) {
                  ...
                  player.chooseToDiscard("你被金属性卡牌克制，需弃置一张牌", true, "he").ai = ai.get.disvalue;
                  player.popup("金克木");
                }
                ;
                return;
          ...
          case "wood":
            switch (player.wunature) {
              case "soil":
                if (player.num("he")) {
                  game.log(get.translation(player) + "被" + get.translation(trigger.card.wunature) + "属性的卡牌克制");
                  player.chooseToDiscard("你被木属性卡牌克制，需弃置一张牌", true, "he").ai = ai.get.disvalue;
                  player.popup("木克土");
                }
                ;
                return;
          ...
          case "water":
            switch (player.wunature) {
              case "fire":
                if (player.num("he")) {
                  game.log(get.translation(player) + "被" + get.translation(trigger.card.wunature) + "属性的卡牌克制");
                  player.chooseToDiscard("你被水属性卡牌克制，需弃置一张牌", true, "he").ai = ai.get.disvalue;
                  player.popup("水克火");
                }
                ;
                return;
          ...
          case "fire":
            switch (player.wunature) {
              case "metal":
                if (player.num("he")) {
                  game.log(get.translation(player) + "被" + get.translation(trigger.card.wunature) + "属性的卡牌克制");
                  player.chooseToDiscard("你被火属性卡牌克制，需弃置一张牌", true, "he").ai = ai.get.disvalue;
                  player.popup("火克金");
                }
                ;
                return;
          ...
          case "soil":
            switch (player.wunature) {
              case "water":
                if (player.num("he")) {
                  game.log(get.translation(player) + "被" + get.translation(trigger.card.wunature) + "属性的卡牌克制");
                  player.chooseToDiscard("你被土属性卡牌克制，需弃置一张牌", true, "he").ai = ai.get.disvalue;
                  player.popup("土克水");
                }
                ;
                return;
