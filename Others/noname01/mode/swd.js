        ...
        var control = ui.create.control("完成", function() {
          ...
          for (var i = 0; i < 10; i++) {
            ...
            switch (dialog.content.childNodes[i].firstChild.innerHTML) {
              case "主动技能一":
                game.me.learned1 = link;
                break;
              case "主动技能二":
                game.me.learned2 = link;
                break;
              case "被动技能一":
                game.me.learned3 = link;
                break;
              case "被动技能二":
                game.me.learned4 = link;
                break;
              case "锁定技能一":
                game.me.learned5 = link;
                break;
              case "锁定技能二":
                game.me.learned6 = link;
                break;
              case "限定技":
                game.me.learned7 = link;
                break;
            }
